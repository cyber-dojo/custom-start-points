...
below to score a GIVEN set of five dice in a GIVEN category.

However, the code and tests are (deliberately) very poor.
...
twos, fives, pair, two pairs etc (see below). 

If the roll is compatible with the category, the player gets a 
score for the roll according to the rules of that category. 

If the roll is not compatible with the category, the player 
scores zero for the roll.
